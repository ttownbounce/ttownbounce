    ...
    <div className="container-fluid text-center text-md-left">
      <div className="row">
        <div className="col-md-6 mt-md-0 mt-3">
          ...
          <p className="bluefortext textFontSize">
            ...
            additional delivery fee may be added in some cases depending on your
            distance from us. Please give us a call with any questions
            205-454-5120
          </p>
        </div>
